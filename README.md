...
README.md is based on README.txt - updated on 27/02/2018 - v1.22.13 - latest version can be found here: https://github.com/MultiPoolMiner/MultiPoolMiner/blob/master/README.txt
