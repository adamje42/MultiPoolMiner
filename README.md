...
README.md is based on README.txt - updated on 23/02/2018 - v1.22.12 - latest version can be found here: https://github.com/MultiPoolMiner/MultiPoolMiner/blob/master/README.txt
